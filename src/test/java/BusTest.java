...
class BusTest {
    ...
    void test4_decreaseCapacity_allowed() {
        ...
        Bus b = new Bus("12345678", 50, 80.0, "Diesel");
        assertDoesNotThrow(() -> b.validateCapacityUpdate(40));
    }
    ...
    void test6_sameCapacity_allowed() {
        ...
        Bus b = new Bus("12345678", 50, 80.0, "Diesel");
        assertDoesNotThrow(() -> b.validateCapacityUpdate(50));
    }
    ...
    void test7_youngDriver_bigBus_allowed() {
        ...
        assertDoesNotThrow(() -> b.validateDriverAssignment(d));
    }
